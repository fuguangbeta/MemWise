...
## 测试与构建
- 回归：`python -B scripts\test_v2.6.py`（185 项断言，-B 避 pyc 缓存锁；本机已设 PYTHONPYCACHEPREFIX）
...
1. 修改完成 → 185 项回归全绿 → 更新 CHANGELOG（用户视角规范）
